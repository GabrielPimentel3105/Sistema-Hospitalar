...
class Paciente {
    ...
    private function executarDAO($metodo, $argumentos = []) {
        $daoPath = __DIR__ . '/../dao/PacienteDAO.php';
        ...
        if (empty($argumentos)) {
            ...
            if ($metodo === 'delete') {
                return $dao->delete($this->__get('id_paciente'));
            }
        }
    ...
    public function countInternados(...$argumentos) {
        return $this->executarDAO('countInternados', $argumentos);
    }
}
?>